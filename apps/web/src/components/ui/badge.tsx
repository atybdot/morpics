  ...
  "inline-flex items-center justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success:
          "bg-[var(--color-success-accent,var(--color-green-600))] text-[var(--color-success-foreground,var(--color-white))]",
        warning:
...
const badgeButtonVariants = cva(
  "cursor-pointer transition-all inline-flex items-center justify-center leading-none size-3.5 [&>svg]:opacity-100! [&>svg]:size-3.5 p-0 -me-0.5 opacity-60 hover:opacity-100",
  {
    variants: {
      variant: {
        default: "",
