...
interface TypewriterProps {
  ...
  /**
   * Callback when displayed text changes
   */
  onTextChange?: (text: string, textIndex: number, isComplete: boolean) => void;
}
...
const Typewriter = ({
  ...
  // Call onTextChange callback when text changes
  useEffect(() => {
    if (onTextChange) {
      const currentText = texts[currentTextIndex];
      const isComplete = displayText === currentText && !isDeleting;
      onTextChange(displayText, currentTextIndex, isComplete);
    }
  }, [displayText, currentTextIndex, isDeleting, onTextChange, texts]);
