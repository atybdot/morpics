...
export const formatEnum = pgEnum("format_enum", [
  "image/png",
  "image/webp",
  "image/avif",
  "image/svg+xml",
...
export const transformationMetadata = pgTable(
  ...
  (table) => [
    foreignKey({
      ...
      name: "transformation_metadata_image_id_transformation_id_fk",
    }).onDelete("cascade"),
    unique("transformation_metadata_image_id_unique").on(table.imageId),
  ],
);
